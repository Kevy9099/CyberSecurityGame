...
//  private Button resetButton;
  ...
  private final HQuestions questionsArray = new HQuestions();

  private String answers;

  private final int questionsLength = questionsArray.questionsArray.length;

  private final long startTimeInMillis = 10000; // 10secs
...
//  }
  ...
  private void outOfTime() {
    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(HardQuestions.this);
